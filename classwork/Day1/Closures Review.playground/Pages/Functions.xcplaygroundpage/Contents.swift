...
//Write the function here
func getGuestsName(guests:[Guest]) {
    guests.forEach {
        print("Guest name: ", $0)
    }
}
...
getGuestsName(guests: invitedGuests)
/*:
...
//Write the function here
func getAdultGuests(guests:[Guest]) -> [Guest] {
    return guests.filter{ $0.age > 18 } //creates an array of guest from guests with age greater than 18
}
...
print(getAdultGuests(guests: invitedGuests))
/*:
